 ...
 <div class="container" id="top-cards">
        <div class="row">
            <div class="col-md-5 py-3 py-md-0">
                <div class="card" style="background-color: #a9a9a926;">
                    <img src="./assets/image/topcard1.png" alt="">
            ...
            <div class="col-md-4 py-3 py-md-0">
                <div class="card" style="background-color: #a9a9a926;">
                    <img src="./assets/image/topcard2.png" alt="">
                    <div class="card-img-overlay">
            ...
            <div class="col-md-3 py-3 py-md-0">
                <div class="card" style="background-color: #a9a9a926;">
                    <img src="./assets/image/topcard3.png" alt="">
                    <div class="card-img-overlay">
    ...
    <div class="container" id="product-cards">
        ...
        <div class="row" style="margin-top: 30px;">
            ...
            <div class="col-md-3 py-3 py-md-0">
                <div class="card">
                    <img src="./assets/image/p14.png" alt="">
                    <div class="card-body">
                        <h3>Purple Heel</h3>
                        <p>Lorem ipsum dolor sit amet.</p>
                        <div class="star">
            ...
            <div class="col-md-3 py-3 py-md-0">
                <div class="card">
                    <img src="./assets/image/p15.png" alt="">
                    <div class="card-body">
                        <h3>Men Shoes</h3>
                        <p>Lorem ipsum dolor sit amet.</p>
                        <div class="star">
        ...
        <div class="row" style="margin-top: 30px;">
            <div class="col-md-3 py-3 py-md-0">
                <div class="card">
                    <img src="./assets/image/p17.png" alt="">
                    <div class="card-body">
                        <h3>Blue T-Shirt</h3>
                        <p>Lorem ipsum dolor sit amet.</p>
                        <div class="star">
            ...
            <div class="col-md-3 py-3 py-md-0">
                <div class="card">
                    <img src="./assets/image/p18.png" alt="">
                    <div class="card-body">
                        <h3>Girls Sandal</h3>
                        <p>Lorem ipsum dolor sit amet.</p>
                        <div class="star">
